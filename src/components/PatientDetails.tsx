  ...
  return (
    <div className="mx-5 my-10 px-5 py-10 bg-white shadow-md rounded-xl">
        ...
        <div className="flex flex-col lg:flex-row gap-3 justify-between mt-10">
            <button 
                type="button"
                className="py-2 px-10 bg-indigo-600 hover:border-t-indigo-700 text-white font-bold uppercase rounded-lg"
            ...
            <button 
                type="button"
                className="py-2 px-10 bg-red-600 hover:border-t-red-700 text-white font-bold uppercase rounded-lg"
                onClick={handleClick}
            >
                    Delete
            </button>
